...
public class AnalyticsController {
    ...
    public ResponseEntity<ApiResponse<Map<String, Long>>> getOrdersByStatus(@RequestParam UUID boutiqueId) {
        return ResponseEntity.ok(ApiResponse.ok(analyticsService.getOrdersByStatus(boutiqueId)));
    }

    @GetMapping("/traffic-sources")
    public ResponseEntity<ApiResponse<Map<String, Long>>> getTrafficSources(@RequestParam UUID boutiqueId) {
